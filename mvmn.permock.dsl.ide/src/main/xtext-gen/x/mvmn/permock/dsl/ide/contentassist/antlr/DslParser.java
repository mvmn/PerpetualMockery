...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPropertyRefAccess().getCollectionAccessAssignment_0_1(), "rule__PropertyRef__CollectionAccessAssignment_0_1");
			builder.put(grammarAccess.getPropertyRefAccess().getListFuncAssignment_0_2(), "rule__PropertyRef__ListFuncAssignment_0_2");
